  ...
  <body>
    ...
    <div class="container">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <span><div class="container"><table class="table table-hover table-condensed" id='cdinfo'> </table></div></span>
			...
			<div class="table-responsive">
				<table class="table table-hover table-condensed table-striped">
				    ...
				    %>
				        ...
				        <td>
					        <dl>
								<dt><a href="#" id ="<%=URLMapper.DETAIL_URL%>?cdId=<%=productList.get(i).getId()%>"><%=productList.get(i).getTitle() %></a></dt>
